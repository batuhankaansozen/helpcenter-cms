...
const sidebarMenuConfig = [
  {
    ...
    items: [
      { id: "account-settings", title: "Profil Ayarları" }, // `account-settings` id'li öğeyi kullanırız
      { id: "login-password", title: "Şifre Değiştir" },     // `login-password` id'li öğeyi kullanırız
      // Eğer "Yeni Kullanıcı" veya "Kullanıcıları Yönet" gibi özel sayfalarınız yoksa ve bunlar sadece sidebar içinse, bunları doğrudan burada tanımlayabilirsiniz.
      // Ancak genellikle bu tip öğeler de bir `id` ve içerik ile contentData'da yer alır.
      // Şimdilik varsayımsal olarak contentData'da olmayan 2 öğe ekliyorum. Eğer varsa, onların id'lerini kullanın.
      { id: "new-user-creation", title: "Yeni Kullanıcı", icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>
      )},
      { id: "manage-users", title: "Kullanıcıları Yönet", icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    items: [
      { id: "account-settings", title: "Müşteri Hesapları" },
      // Buraya başka hesap yönetimi ile ilgili contentData öğelerinin id'lerini ekleyebilirsiniz
    ],
  },
  {
    ...
    items: [
      // Not: Bu kısımda `allDynamicContent`'deki id'leri kullanmalıyız.
      // `overview` diye bir id yok, eğer yoksa eklemeli veya uygun olanı seçmeliyiz.
      // Örnek olarak, `assethq-media-management`'ı kullanabiliriz veya yeni bir id tanımlarız.
      { id: "assethq-media-management", title: "Overview" }, // contentData'daki id'yi kullan
      // Eğer "Upload Assets" ve "Manage Assets" ayrı sayfalar veya içerik bloklarıysa, onların da id'lerini ekleyin
      { id: "upload-assets", title: "Upload Assets" }, // Varsayımsal id
      { id: "manage-assets", title: "Manage Assets" }, // Varsayımsal id
    ],
  },
  {
    title: "NewsHQ",
    ...
    items: [
      { id: "newshq-usage", title: "Latest News" },
      { id: "news-categories", title: "News Categories" }, // Varsayımsal id
      { id: "authors", title: "Authors" },                 // Varsayımsal id
    ],
  },
  {
    title: "AssetHQ",
    ...
    items: [
      { id: "create-alert", title: "Create Alert" }, // Varsayımsal id
      { id: "manage-alerts", title: "Manage Alerts" }, // Varsayımsal id
    ],
  },
  {
    title: "VPN",
    ...
    items: [
      { id: "translation-requests", title: "Translation Requests" }, // Varsayımsal id
      { id: "language-management", title: "Language Management" }, // Varsayımsal id
    ],
  },
  {
    title: "CMS User Guide",
    ...
    items: [
      { id: "create-playlist", title: "Create Playlist" }, // Varsayımsal id
      { id: "edit-playlists", title: "Edit Playlists" },   // Varsayımsal id
    ],
  },
  ...
  },
  {
    ...
    items: [
      { id: "new-episodes", title: "New Episodes" },         // Varsayımsal id
      { id: "series-management", title: "Series Management" }, // Varsayımsal id
    ],
  },
];
