...
const allDynamicContent = [
  // POPÜLER KONULAR (Eski içerikleriniz)
  {
    id: 'hesap-ayarlari',
    category: 'popular-topics',
    title: 'Hesap Ayarları',
    description: 'Ayarları değiştirin, bildirimleri yönetin, ad değişiklikleri hakkında bilgi alın ve daha fazlasını yapın.',
    content:
  ...
  },
  {
    ...
    description: 'Giriş sorunlarını giderin ve şifrenizi nasıl değiştireceğinizi veya yenileyeceğinizi öğrenin.',
    content:
      'Şifrenizi sıfırlama, iki faktörlü kimlik doğrulama ayarları ve sık karşılaşılan giriş sorunlarına çözümler bu bölümde yer alıyor. Güvenli giriş uygulamaları ve hesap güvenliği ipuçları.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    ...
    description: 'Paylaştıklarınızı kimlerin görebileceğini kontrol edin ve hesabınıza ekstra koruma ekleyin.',
    content:
      'Hesabınızın gizlilik ayarlarını yapılandırma, istenmeyen kişileri engelleme ve şüpheli etkinliklere karşı korunma yolları hakkında bilgi edinin. Veri gizliliği ve güvenlik politikalarımız hakkında detaylı bilgi.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    ...
    category: 'popular-topics',
    title: 'Marketplace',
    description: 'Facebook\'ta nasıl ürün satın alacağınızı, yöneteceğinizi ve satacağınızı öğrenin.',
    // BURAYI GÜNCELLEDİK: content artık bir video iframe'i
    content: (
      <div className="video-wrapper" style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
        <iframe
          src="https://drive.google.com/file/d/13K4IWW9pBaOl5V6LKhJLgQxn5hNWa-qy/preview" // Kendi Google Drive video URL'nizi buraya yapıştırın
          width="100%"
          height="450" // Video için uygun bir yükseklik
          allow="autoplay; fullscreen; picture-in-picture"
          allowFullScreen // Tam ekran moduna izin ver
          title="Marketplace Öğretici Videosu"
          style={{ border: 'none' }} // Çerçeve kenarlığını kaldır
        ></iframe>
      </div>
    ),
    icon: (
  ...
  },
  {
    ...
    category: 'popular-topics',
    title: 'Gruplar',
    description: 'Grupları nasıl oluşturacağınızı, yöneteceğinizi ve kullanacağınızı öğrenin.',
    content:
      'İlgi alanlarınıza göre gruplara katılma, yeni gruplar oluşturma ve grup ayarlarını yönetme rehberi. Grup içindeki gönderiler, etkinlikler ve bildirimler.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    ...
    category: 'popular-topics',
    title: 'Sayfalar',
    description: 'Bir Sayfayı nasıl oluşturacağınızı, kullanacağınızı, takip edeceğinizi ve yöneteceğinizi öğrenin.',
    content:
      'Markalar, topluluklar veya kişisel kullanımlar için Sayfa oluşturma ve Sayfa yönetimi adımları. Sayfa istatistiklerini takip etme ve gönderi planlama.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 256 256">
  ...
  // ACCOUNT SETUP
  {
    ...
    description: 'Learn how to create your Tech Solutions account and set up your profile.',
    content:
      'Tech Solutions hesabınızı oluşturmak için adım adım rehber. Kayıt süreci, e-posta doğrulama ve ilk giriş adımları.',
    icon: (
  ...
  },
  {
    ...
    description: 'Customize your profile with a profile picture, bio, and other personal details.',
    content:
      'Profilinizi kişiselleştirme, profil resmi ekleme, biyografi yazma ve diğer kişisel bilgilerinizi düzenleme yönergeleri. Profil görünürlüğü ayarları.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
  ...
  // EXPLORING THE PLATFORM
  {
    ...
    content:
      'Platformun temel özelliklerini ve işlevlerini öğrenin. Ana menü, panolar ve araç çubuklarının kullanımı hakkında rehber.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    ...
    content:
      'Arama özelliğimizi kullanarak belirli bilgileri veya kaynakları nasıl bulacağınızı öğrenin. Gelişmiş arama filtreleri ve anahtar kelime ipuçları.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
  ...
  // BASIC ASSISTANCE
  {
    ...
    content:
      'Tech Solutions kullanımıyla ilgili sıkça sorulan soruların yanıtlarını bulun. En popüler sorular ve hızlı çözümler.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    ...
    content:
      'Kişiselleştirilmiş yardım için destek ekibimizle iletişime geçin. Destek kanalları, çalışma saatleri ve beklenen yanıt süreleri.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
  ...
  {
    id: 'about',
    category: 'header-links', // Yeni bir kategori ekledik
    title: 'Hakkımızda',
    ...
    icon: null, // Bu sayfalar için ikon gerekli olmayabilir
  },
  {
    id: 'products',
...
// allDynamicContent dizisini dışarıya aktarıyoruz
